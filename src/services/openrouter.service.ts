...
export class OpenRouterService {
  ...
  /**
   * Trích xuất câu hỏi phỏng vấn từ PDF bằng Google Gemini 1.5 Flash 8B (thông qua OpenRouter)
   */
...
Hãy trả về một JSON object chứa mảng các câu hỏi phỏng vấn theo đúng định dạng cấu trúc sau:
{
  ...
  public static async transcribeAudio(fileBuffer: Buffer, mimeType: string): Promise<string> {
    try {
      ...
      console.log(`[Native STT] Sử dụng endpoint Native của Google Gemini 1.5 Flash 8B cho bóc băng`);
